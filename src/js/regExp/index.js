...
// 学习\B
// 匹配开头后面1后面的
replace('123', /\B(\d)/g, 'B') // 1BB
replace('123', /\B(\d{2})/g, 'B') // 1B
replace('1232', /\B(\d{2})/g, 'B') // 1B2
replace('12322', /\B(\d{2})/g, 'B') // 1BB
replace('12322', /\B(\d{3})/, 'B') // 1B2
replace('123222', /\B(\d{3})+/g, 'B') // 1B2
replace('1232232', /\B(\d{3})/g, ',$1') // 1BB
replace('12322322', /\B(\d{3})$/g, ',$1') // 12322,322B
replace('2222444', /\B(?=(\d{3})+$)/g, ',') // 12322,322B



// replace('2222444', /\B((\d{3})+(?!\d))/g, '$1') // 12322,322B

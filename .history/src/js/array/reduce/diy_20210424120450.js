...
Array.prototype.myFlat = function (depth=1) {
  ...
  function reducer (accumulator, current, deep = 0) {
    depth ++
    return Array.isArray(current) && deep < depth ? accumulator.concat(current.reduce((a, b) => reducer(a, b, deep))) : accumulator.concat(current)
  }
  return this.reduce((a, b) => reducer(a, b, 0), [])
}
